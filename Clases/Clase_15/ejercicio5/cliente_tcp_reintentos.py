...
### Intenta conectarse con settimeout(1.5). Si falla (timeout o refused), 
### reintenta con backoff lineal (base_backoff * intento). Envía ping\n y espera respuesta.